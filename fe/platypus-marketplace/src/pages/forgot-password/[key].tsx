import NewResetPasswordForm from "@/components/Form/NewResetPasswordForm";
...
export interface INewPasswordReset {
  changeCode: string;
}

const NewPasswordReset = ({ changeCode }: INewPasswordReset) => {
    ...
    <>
      ...
      <main className="min-w-screen flex min-h-screen flex-col items-center justify-center gap-3">
        ...
        <p className="text-sm font-thin">
          2 minutes access to reset your password
        </p>
        ...
        <div>
          {min > 0 || sec > 0 ? (
            <NewResetPasswordForm changeCode={changeCode} />
          ) : (
            <div className="flex flex-col items-center justify-center gap-3">
              <p className="text-sm font-thin">
                {`Time's up, go request for new Reset Password Link`}
              </p>
