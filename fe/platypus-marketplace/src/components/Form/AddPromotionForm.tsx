...
export function AddPromotionForm() {
  ...
  async function onSubmit(dataa: z.infer<typeof FormSchema>) {
    ...
    if (dataa.promotion_type === "CUT") {
      ...
      const { error, data } = await service.postNewProductPromotion(payload);
      if (error) {
  ...
  return (
    <div id="new-promotion-form" className="mb-5 mt-10 max-lg:mt-40">
      <h2 className="mb-5 text-xl font-bold text-primary md:text-4xl">
        Add New Merchant Promotion
      </h2>
      <Form {...form}>
        <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-1">
          ...
          <ButtonWithLoading
            ...
            buttonContent="Create and Apply"
